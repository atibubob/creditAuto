...
<body>
    ...
    <div> <a class="a" href ="{{route('create')}}"> ajouter un nouveau vehicule </a> </div>
    <div class="content">
        <div>
        <h1 align="center"> tous les vehicules </h1>
        </div>
        <table>
            <thead>
            <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action">
                        <a class="modifier" href="{{route('edite',$vehicules->id)}}">modifier</a>
                        <form action="{{route('supprimer',$vehicules->id)}}" method = "post">
                            @csrf
                            @method('DELETE')
